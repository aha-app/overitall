...
- `P` - Toggle process tree view (managed processes and their child processes) in the content area; `P` or `Esc` returns to logs. In tree view, use `↑`/`↓`, `PageUp`/`PageDown`, `Home`/`End`, or mouse wheel to scroll.
