...
pub fn create_manager_with_logs() -> ProcessManager {
    ...
    manager.add_process("web".to_string(), "ruby web.rb".to_string(), None, None, None, None);
    manager.add_process("worker".to_string(), "ruby worker.rb".to_string(), None, None, None, None);
...
pub fn create_manager_with_custom_status() -> ProcessManager {
    ...
    let mut manager = ProcessManager::new();
    manager.add_process("web".to_string(), "echo hi".to_string(), None, Some(&status_config), None, None);
    manager.add_process("worker".to_string(), "echo hi".to_string(), None, None, None, None);
...
pub fn create_manager_with_mixed_states() -> ProcessManager {
    ...
    manager.add_process("api".to_string(), "echo hi".to_string(), None, None, None, None);
    ...
    manager.add_process("db".to_string(), "echo hi".to_string(), None, Some(&db_config), None, None);
    ...
    manager.add_process("mailer".to_string(), "echo hi".to_string(), None, None, None, None);
...
pub fn create_manager_with_many_processes() -> ProcessManager {
    ...
    manager.add_process("web".to_string(), "echo hi".to_string(), None, Some(&web_config), None, None);
    ...
    manager.add_process("api".to_string(), "echo hi".to_string(), None, Some(&api_config), None, None);
    manager.reset_process_status("api"); // Apply default custom status

    // Regular processes (no custom status)
    manager.add_process("worker".to_string(), "echo hi".to_string(), None, None, None, None);
    manager.add_process("scheduler".to_string(), "echo hi".to_string(), None, None, None, None);
    manager.add_process("mailer".to_string(), "echo hi".to_string(), None, None, None, None);
    manager.add_process("cache".to_string(), "echo hi".to_string(), None, None, None, None);
    manager.add_process("db".to_string(), "echo hi".to_string(), None, None, None, None);
    manager.add_process("redis".to_string(), "echo hi".to_string(), None, None, None, None);
    manager.add_process("nginx".to_string(), "echo hi".to_string(), None, None, None, None);
    manager.add_process("postgres".to_string(), "echo hi".to_string(), None, None, None, None);
    manager.add_process("elasticsearch".to_string(), "echo hi".to_string(), None, None, None, None);
    manager.add_process("sidekiq".to_string(), "echo hi".to_string(), None, None, None, None);
